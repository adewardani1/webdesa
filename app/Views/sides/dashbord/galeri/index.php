                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item active">
                            <a href="<?php echo base_url('sides/galeri'); ?>" class="nav-link active">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <a class="btn btn-primary" href="<?php echo base_url('/sides/galeri/create'); ?>">Tambah Data</a>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($galeri as $row) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo base_url('sides/galeri/foto/' . $row->id); ?>" class="btn btn-outline-primary"><i class="fas fa-image"></i> Download</a></td>
                                                    <td><?php echo $row->created_at; ?></td>
                                                    <td><?php echo $row->updated_at; ?></td>
                                                    <td>
                                                        <div class="btn-group" role="group" aria-label="Basic example">
                                                            <a class="btn btn-danger" href="<?php echo base_url('sides/galeri/delete/' . $row->id); ?>">Hapus</a>
                                                            <a class="btn btn-warning" href="<?php echo base_url('sides/galeri/show/' . $row->id); ?>">Edit</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php }
