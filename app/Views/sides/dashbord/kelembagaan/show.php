                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card card-info">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url('sides/kelembagaan/update/' . $kelembagaan->id); ?>">
                                    <?php $validation = \Config\Services::validation(); ?>
                                    <div class="card-body">
                                        <div class="form-group row">
                                            <label for="inputEmail3" class="col-sm-2 col-form-label">Nama Kelembagaan</label>
                                            <div class="col-sm-10">
                                                <input type="text" value="<?php echo $kelembagaan->nama; ?>" name="nama" class="form-control <?php echo $validation->hasError('nama') ? 'is-invalid' : null ?>" placeholder="Nama Kelembagaan">
