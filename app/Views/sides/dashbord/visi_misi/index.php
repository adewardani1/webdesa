                                        ...
                                        <tbody>
                                            ...
                                            foreach ($visiMisi as $row) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo base_url('sides/visimisi/foto/' . $row->id); ?>" class="btn btn-outline-primary"><i class="fas fa-image"></i> Download</a></td>
                                                    <td><?php echo $row->created_at; ?></td>
                                                    <td><?php echo $row->updated_at; ?></td>
                                                    <td>
                                                        <div class="btn-group" role="group" aria-label="Basic example">
                                                            <a class="btn btn-danger" href="<?php echo base_url('sides/visimisi/delete/' . $row->id); ?>">Hapus</a>
                                                            <a class="btn btn-warning" href="<?php echo base_url('sides/visimisi/show/' . $row->id); ?>">Edit</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php }
