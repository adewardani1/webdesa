...
<div class="jumbotron-detail" style="background: linear-gradient(rgba(51, 51, 51, 0.5), rgba(51, 51, 51, 0.5)), url('/img/berita/<?php echo $event->gambar; ?>');">
    <p><?php echo date("Y-m-d", strtotime($event->updated_at)); ?> By <?php echo $event->nama_depan; ?></p>
        ...
        <div class="row">
            <div class="col-sm-7">
                ...
                <div class="row row-above">
                    <form action="<?php echo base_url('comment/submit/' . $event->id); ?>" method="post">
                        <div class="col-sm-12">
                            <h1>LEAVE A REPLY</h1>
                ...
                <div class="side">
                    <div class="group-side" style="margin-left: 100px">
                        ...
                        <div class="widget">
                            <h5>RECENT POST</h5>
                            <div class="">
                                <span class="judul"><a href="<?php echo base_url('news/' . $recentEvent->id); ?>" title=""><?php echo $recentEvent->judul; ?></a></span>
                                <time class="waktu"><?php echo date("Y-m-d", strtotime($recentEvent->updated_at)); ?></time>
                            </div>
                        </div>
                    </div>
                </div>
